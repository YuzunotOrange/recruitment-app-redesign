...
function SplitDateInput({ value, onChange, required = false, ariaLabel }: SplitDateInputProps) {
  ...
  return (
    <div
      className="flex w-full min-w-0 items-center gap-1 rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground focus-within:ring-2 focus-within:ring-ring lg:col-span-2"
